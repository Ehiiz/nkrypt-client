...
export default function Passcode({passCell, updatePass}){
    ...
    return(
        ...
        <input className="rounded-2xl bg-secondary-500 placeholder:pl-4 h-10 shadow-sm" type="text" name="answer" placeholder="Enter your passcode" value={passCell.answer} onChange={updatePass} />
        </div>
